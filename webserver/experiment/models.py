...
class Experiment(models.Model):
    ...
    link = models.CharField('Link to the experiment', max_length=100, unique=True, help_text="Unique identifier (slug) for the experiment URL. Should match the dirname in runner/experiments/")
