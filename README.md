[![versions](https://img.shields.io/badge/python-3.11-blue)](#) [![motivating-paper](https://img.shields.io/badge/paper-motivation-blue)](https://doi.org/10.48550/arXiv.2501.19245) [![docs](https://app.readthedocs.org/projects/sharpie/badge/?version=latest)](https://sharpie.readthedocs.io/en/latest/index.html) [![PyPI version](https://badge.fury.io/py/SHARPIE.svg)](https://badge.fury.io/py/SHARPIE)
...
## Documentation
You can find the documentation [here](https://sharpie.readthedocs.io/en/latest/), use registration key `sharpie` for the [hosted demo](https://sharpie.science.uu.nl/).
