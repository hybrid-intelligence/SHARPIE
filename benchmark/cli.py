...
Prerequisites:
  ...
  4. Start runner: cd runner && python manage.py --connection-key=YOUR_KEY
    ...
    parser.add_argument(
        "--suite",
        choices=["scalability", "ai-agents", "network-latency"],
        help="Run predefined benchmark suite (scalability=participants, ai-agents=AI agents, network-latency=latency presets)",
    )
